    ...
    body: new SceneGridLayout({
      ...
      children: [
        new SceneGridItem({
          ...
          isDraggable: false,
          body: new VizPanel({
            title: 'FSW subsystem panel',
            pluginId: 'text',
            options: {
              content: 'FSW <in development>',
            },
          }),
          // body: new VizPanel({
          //   title: '',
...
const getFSWAppScenePage = () => {
  return new SceneApp({
    pages: [
      new SceneAppPage({
        // $timeRange: new SceneTimeRange({ from: 'now-6h', to: 'now' }),
        title: "FSW subsystem",
        subTitle: 'This scene showcases the FSW functionality.',
        // controls: [new SceneTimePicker({ isOnCanvas: false })],
        url: prefixRoute(`${ROUTES.FSW}`),
...
export const FSWPage = () => {
  // const scene = getScene();
  const scene = useMemo(() => getFSWAppScenePage(), []);
