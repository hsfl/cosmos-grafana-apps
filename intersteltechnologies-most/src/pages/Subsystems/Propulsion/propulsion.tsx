    ...
    body: new SceneGridLayout({
      ...
      children: [
        new SceneGridItem({
          ...
          isDraggable: false,
          body: new VizPanel({
            title: 'Propulsion subsystem panel',
            pluginId: 'text',
            options: {
              content: 'Propulsion <in development>',
            },
          }),
          // body: new VizPanel({
          //   title: '',
...
const getPropulsionAppScenePage = () => {
  return new SceneApp({
    pages: [
      new SceneAppPage({
        // $timeRange: new SceneTimeRange({ from: 'now-6h', to: 'now' }),
        title: "Propulsion subsystem",
        subTitle: 'This scene showcases the Propulsion functionality.',
        // controls: [new SceneTimePicker({ isOnCanvas: false })],
        url: prefixRoute(`${ROUTES.Propulsion}`),
...
export const PropulsionPage = () => {
  ...
  const scene = useMemo(() => getPropulsionAppScenePage(), []);
