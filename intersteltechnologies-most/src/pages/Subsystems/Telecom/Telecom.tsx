    ...
    body: new SceneGridLayout({
      ...
      children: [
        new SceneGridItem({
          ...
          isDraggable: false,
          body: new VizPanel({
            title: 'Telecom subsystem panel',
            pluginId: 'text',
            options: {
              content: 'Telecom <in development>',
            },
          }),
          // body: new VizPanel({
          //   title: '',
...
const getTelecomAppScenePage = () => {
  return new SceneApp({
    pages: [
      new SceneAppPage({
        // $timeRange: new SceneTimeRange({ from: 'now-6h', to: 'now' }),
        title: "Telecom subsystem",
        subTitle: 'This scene showcases the Telecom functionality.',
        // controls: [new SceneTimePicker({ isOnCanvas: false })],
        url: prefixRoute(`${ROUTES.Telecom}`),
...
export const TelecomPage = () => {
  // const scene = getScene();
  const scene = useMemo(() => getTelecomAppScenePage(), []);
