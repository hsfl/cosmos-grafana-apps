    ...
    body: new SceneGridLayout({
      ...
      children: [
        new SceneGridItem({
          ...
          isDraggable: false,
          body: new VizPanel({
            title: 'Flight Dynamics subsystem panel',
            pluginId: 'text',
            options: {
              content: 'Flight Dynamics <in development>',
            },
          }),
          // body: new VizPanel({
          //   title: '',
...
const getFlightDynamicsAppScenePage = () => {
  return new SceneApp({
    pages: [
      new SceneAppPage({
        // $timeRange: new SceneTimeRange({ from: 'now-6h', to: 'now' }),
        title: "Flight Dynamics subsystem",
        subTitle: 'This scene showcases the Flight Dynamics functionality.',
        // controls: [new SceneTimePicker({ isOnCanvas: false })],
        url: prefixRoute(`${ROUTES.FlightDynamics}`),
...
export const FlightDynamicsPage = () => {
  // const scene = getScene();
  const scene = useMemo(() => getFlightDynamicsAppScenePage(), []);
